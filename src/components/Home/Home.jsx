...
const Home = () => {
  return (
    <div className ='contenedor'>
        ...
        <Imagenes/>
        <div className="information-nutrimental">
            <h3 className='informacion' >Information nutrimental</h3>
            <strong > Vitalinea® Bebible Guayaba 217gr <br   />  Valor promedio por porcién de 217ar <br />
            ...
            Leche descremada pasteurizada y/o reconstituida
             pasteurizada de vaca. 3.5% preparado de fruta
             guayaba (acesulfame K y sucralosa (27.2mg/100g)),
             crema, almidén modificado, maltodextrina y cultivos
            lacticos.
            </p>
        ...
        Términos y condiciones! Politicas de pivacidad | Aviso de privacidad <br />
